...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    */
    ...
    void moveToState(int newState, boolean always) {
        ...
        if (this.mActive != null) {
            ...
            if (this.mAdded != null) {
                ...
                boolean loadersRunning2 = false;
                for (int i = 0; i < numAdded; i++) {
                    Fragment f = this.mAdded.get(i);
                    moveFragmentToExpectedState(f);
                    if (f.mLoaderManager != null) {
                        loadersRunning2 |= f.mLoaderManager.hasRunningLoaders();
                    }
                }
                loadersRunning = loadersRunning2;
            }
            int numActive = this.mActive.size();
            boolean loadersRunning3 = loadersRunning;
            for (int i2 = 0; i2 < numActive; i2++) {
                ...
                if (f2 != null && ((f2.mRemoving || f2.mDetached) && !f2.mIsNewlyAdded)) {
                    ...
                    if (f2.mLoaderManager != null) {
                        loadersRunning3 |= f2.mLoaderManager.hasRunningLoaders();
                    }
                }
            }
            if (!loadersRunning3) {
    ...
    FragmentManagerNonConfig retainNonConfig() {
        ...
        return new FragmentManagerNonConfig(fragments, fragments2);
    }
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (containerId != -1 || id != -1 || tag != null) {
            ...
            if (fragment3 == null) {
                Fragment fragment4 = Fragment.instantiate(context, fname2);
