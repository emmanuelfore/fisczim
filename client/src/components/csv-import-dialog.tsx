...
export function CsvImportDialog({ type, companyId, onSuccess, trigger }: CsvImportDialogProps) {
    ...
    const getTemplate = () => {
        ...
        if (type === "product") {
            return "Name,Description,SKU,Barcode,Price,Cost Price,Tax Rate,Tax Type,Type,Stock,HS Code,Category,Track Inventory\nWidget A,High quality widget,WID-001,600123456789,10.00,7.50,15.0,VAT-STD,Good,100,0000.00.00,General,Yes\nConsulting,Hourly rate,SVC-001,,50.00,0.00,15.0,VAT-STD,Service,0,,Services,No";
        }
        return "";
    };
