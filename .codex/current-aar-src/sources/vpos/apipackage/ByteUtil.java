...
/* JADX INFO: loaded from: classes.jar:vpos/apipackage/ByteUtil.class */
...
public class ByteUtil {
    ...
    public static String bytesToString(byte[] b) {
        ...
        int length = b.length;
        for (int i = 0; i < length && (ch = (char) (b[i] & 255)) != 0; i++) {
            result.append(ch);
        }
    ...
    public static short BytesToShort(byte[] b, int offset) {
        short x = 0;
        if (b.length - offset >= 2) {
            x = (short) ((b[offset + 1] << 8) | (b[offset + 0] & 255));
        }
        return x;
    }
    ...
    public static int BytesToInt(byte[] b, int offset) {
        int x = 0;
        if (b.length - offset >= 4) {
            x = ((b[offset + 3] & 255) << 24) | ((b[offset + 2] & 255) << 16) | ((b[offset + 1] & 255) << 8) | ((b[offset + 0] & 255) << 0);
        }
        return x;
    }
    ...
    public static long BytesToLong(byte[] b, int offset) {
        long x = 0;
        if (b.length - offset >= 8) {
            x = ((((long) b[offset + 7]) & 255) << 56) | ((((long) b[offset + 6]) & 255) << 48) | ((((long) b[offset + 5]) & 255) << 40) | ((((long) b[offset + 4]) & 255) << 32) | ((((long) b[offset + 3]) & 255) << 24) | ((((long) b[offset + 2]) & 255) << 16) | ((((long) b[offset + 1]) & 255) << 8) | ((((long) b[offset + 0]) & 255) << 0);
        }
        return x;
    }
    ...
    public static float BytesToFloat(byte[] b, int offset) {
        int l = 0;
        if (b.length - offset >= 4) {
            int l2 = b[offset + 0] & 255;
            l = (int) (((long) (((int) (((long) (((int) (((long) l2) | (((long) b[offset + 1]) << 8))) & 65535)) | (((long) b[offset + 2]) << 16))) & 16777215)) | (((long) b[offset + 3]) << 24));
        }
    ...
    public static long toLH(long n) {
        byte[] b = {(byte) (n & 255), (byte) ((n >> 8) & 255), (byte) ((n >> 16) & 255), (byte) ((n >> 24) & 255), (byte) ((n >> 32) & 255), (byte) ((n >> 40) & 255), (byte) ((n >> 48) & 255), (byte) ((n >> 56) & 255)};
    ...
    public static String hexStr2Str(String hexStr) {
        ...
        for (int i = 0; i < bytes.length; i++) {
            ...
            bytes[i] = (byte) ((n + "0123456789ABCDEF".indexOf(hexs[(2 * i) + 1])) & 255);
        }
