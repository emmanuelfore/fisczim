      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className=" text-muted-foreground">
            Manage multiple currencies and exchange rates for reporting
          </p>
        </div>
        <Dialog
          open={isModalOpen}
        ...
        >
          ...
          <DialogContent className="rounded-[2rem]">
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <div className="space-y-0.5">
                  ...
                  <p className="text-[10px] text-slate-500 font-medium">
                    Primary currency for reporting and VAT
                  </p>
                </div>
                <Switch
              ...
              <Button
                type="submit"
                className="w-full h-11 rounded-xl font-black btn-gradient shadow-lg"
                    ...
                    >
                      <TableCell className="font-black font-mono">
                        ...
                        {currency.isBase && (
                          <Badge
                            variant="secondary"
                            className="ml-2 text-[9px] bg-emerald-100 text-emerald-700 font-black border-none"
                          >
                            BASE
                          </Badge>
                        )}
                      ...
                      <TableCell>
                        <Badge
                          ...
                          className={`text-[10px] h-5 font-black uppercase tracking-wider ${currency.isActive ? "bg-slate-900" : "text-slate-300 border-slate-200"}`}
                        >
      ...
      <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100 text-xs text-amber-800 flex gap-3 shadow-sm">
        ...
        <div>
          ...
          <p className="font-medium leading-relaxed italic opacity-80">
            Exchange rates are captured at the moment of invoice creation.
            Updating a rate here will not affect historical records, ensuring
