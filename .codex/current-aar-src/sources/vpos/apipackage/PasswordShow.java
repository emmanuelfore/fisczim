...
/* JADX INFO: loaded from: classes.jar:vpos/apipackage/PasswordShow.class */
public class PasswordShow {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 4:
                    ...
                    String strInfo = b3.getString("MSG");
                    Log.d("PasswordShow", strInfo);
                    PasswordShow.textView.setTextSize(40.0f);
                    PasswordShow.textView.setText(strInfo);
                    break;
                default:
                    Bundle b4 = msg.getData();
                    Log.d("PasswordShow", b4.getString("MSG"));
                    break;
            }
        }
    };
    ...
    /* JADX INFO: loaded from: classes.jar:vpos/apipackage/PasswordShow$KB_Thread.class */
    ...
    /* JADX INFO: loaded from: classes.jar:vpos/apipackage/PasswordShow$BorderTextView.class */
