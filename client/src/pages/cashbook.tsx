...
export default function CashbookPage() {
  ...
  const cashAccounts = accounts?.filter(acc => acc.type === "ASSET" && acc.code.toString().startsWith("10"));
  ...
  const transferMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setTransferData({ fromAccountId: "", toAccountId: "", amount: "", reference: "", notes: "" });
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold font-display text-slate-800">Cashbook & Banks</h1>
              <p className="text-sm text-slate-500">Monitor cash flows and bank accounts</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
                ...
                <div className="space-y-4 pt-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select value={transferData.fromAccountId} onValueChange={v => setTransferData(p => ({ ...p, fromAccountId: v }))}>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={transferData.toAccountId} onValueChange={v => setTransferData(p => ({ ...p, toAccountId: v }))}>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={e => setTransferData(p => ({ ...p, reference: e.target.value }))}
                    />
                  </div>
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <Button 
                      ...
                      disabled={transferMutation.isPending || !transferData.amount || !transferData.fromAccountId || !transferData.toAccountId}
                    >
        ...
        <Card className="rounded-2xl border-slate-200">
          <CardHeader>
            ...
            <CardDescription>View recent deposits, payments, and transfers.</CardDescription>
          </CardHeader>
            ...
            <Table>
              <TableHeader className="bg-slate-50/50">
                <TableRow>
                  ...
                  <TableHead className="text-right text-emerald-600">Money In (Dr)</TableHead>
                  <TableHead className="text-right text-rose-600">Money Out (Cr)</TableHead>
                  {selectedAccountId !== "all" && <TableHead className="text-right pr-6">Balance</TableHead>}
                </TableRow>
              </TableHeader>
              <TableBody>
                {isLoading ? (
                  Array.from({ length: 5 }).map((_, i) => (
                    <TableRow key={i} className="animate-pulse">
                      <TableCell colSpan={selectedAccountId !== "all" ? 6 : 5} className="h-16 bg-slate-50/20" />
                    </TableRow>
                  ))
                ) : entriesWithBalance?.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={selectedAccountId !== "all" ? 6 : 5} className="h-32 text-center text-slate-400">
