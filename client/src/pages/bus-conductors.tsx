...
export default function BusConductorsPage() {
  ...
  async function addConductor() {
    try {
      await createConductor.mutateAsync({
        companyId,
        name,
        email,
        username,
      ...
      toast({
        title: "Conductor added",
        description: `${name || email} can now sign in to the mobile app.`,
      });
      setOpen(false);
      setName("");
      setEmail("");
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  This creates a cashier-level mobile login for issuing bus
                  tickets.
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  disabled={!email || createConductor.isPending}
                >
                  {createConductor.isPending ? (
