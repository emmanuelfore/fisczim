...
export function POSReceipt({
  ...
  return (
    <div
      ...
      className={`bg-white p-2 text-black font-mono text-[10px] leading-tight ${isA4 ? "mx-auto" : ""}`}
    >
      {/* Header */}
      ...
      <div className="mb-4 space-y-1">
        ...
        {invoice.tableId && (
          <div className="flex justify-between border-t border-dashed pt-1 mt-1 font-bold">
            <span>TABLE:</span>
            <span>
              {invoice.notes?.includes("Table: ")
                ? invoice.notes.split("Table: ")[1]
                : invoice.tableId}
            </span>
          </div>
        )}
      ...
      <div className="border-b border-dashed mb-2 pb-1">
        ...
        {receiptItems.map((item: any, idx: number) => (
          <div key={idx} className="flex mb-1">
            <span className="flex-[2] break-words">
      ...
      <div className="space-y-1 mb-4">
        ...
        {invoice.currency !== "USD" && (
          <div className="flex justify-between text-base font-black border-t pt-1">
            ...
            <span>
              {(Number(invoice.total) * Number(invoice.exchangeRate)).toFixed(
                2,
              )}
            </span>
          </div>
      ...
      {invoice.qrCodeData && (
        <div className="flex flex-col items-center gap-2 mb-4 break-inside-avoid">
          ...
          <p className="text-[7px] text-center italic">
            Scan to verify with {company.fiscalProvider === "LEKAKU" || company.country === "Lesotho" ? "RSL" : "ZIMRA"}
          </p>
        </div>
      )}
