      ...
      <DialogContent className="max-w-md rounded-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            This will update the average cost and current stock level.
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="GRN Number, Invoice Ref, etc."
                      className="resize-none rounded-xl bg-slate-50 border-slate-200 focus-visible:ring-emerald-500/20"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
