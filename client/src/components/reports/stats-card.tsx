    ...
    <Card className="border-none shadow-xl bg-white rounded-[2rem] overflow-hidden group hover:shadow-2xl transition-all duration-300 border border-slate-100">
      <CardContent className="p-6">
        <div className="flex justify-between items-start mb-4">
          <p className="text-[10px] font-black font-sans text-slate-400 uppercase tracking-widest">
            {title}
          </p>
          {Icon && (
            <div
              className={cn(
                "p-2.5 rounded-2xl group-hover:scale-110 transition-transform duration-300",
                bg,
              )}
            >
