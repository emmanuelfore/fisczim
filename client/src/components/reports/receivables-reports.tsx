...
export function ArAgingSummaryReport({
  companyId,
  dateRange,
  search,
}: ReportProps) {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await apiFetch(
        buildUrl(companyId, "ar-aging-summary", dateRange),
      );
      if (!res.ok)
        throw new Error(`Failed to load AR aging summary (${res.status})`);
      return res.json();
    },
    enabled: !!companyId,
  });
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/2 border-r border-slate-100 overflow-auto">
        ...
        {filtered.length === 0 ? (
          <EmptyState message="No aging data in this period" />
        ) : (
...
export function ArAgingDetailsReport({
  companyId,
  dateRange,
  search,
}: ReportProps) {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await apiFetch(
        buildUrl(companyId, "ar-aging-details", dateRange),
      );
      if (!res.ok)
        throw new Error(`Failed to load AR aging details (${res.status})`);
      return res.json();
    },
    enabled: !!companyId,
  });
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/2 border-r border-slate-100 overflow-auto">
        ...
        {filtered.length === 0 ? (
          <EmptyState message="No aging details in this period" />
        ) : (
          <table className="w-full text-xs">
            <thead className="sticky top-0 bg-white border-b border-slate-100">
              <tr>
        ...
        {!selectedRow ? (
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <DetailCard
                label="Due Date"
                value={fmtDate(selectedRow.dueDate)}
              />
              <DetailCard
                label="Days Overdue"
                value={selectedRow.daysOverdue}
              />
              ...
              <DetailCard
                ...
                value={
                  <Badge
                    className={cn(
                      "text-[10px] font-bold border-0",
                      bucketClass[selectedRow.bucket] ?? "",
                    )}
                  >
                    {selectedRow.bucket}
                  </Badge>
...
export function InvoiceDetailsReport({
  companyId,
  dateRange,
  search,
}: ReportProps) {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await apiFetch(
        buildUrl(companyId, "invoice-details", dateRange),
      );
      if (!res.ok)
...
export function QuoteDetailsReport({
  companyId,
  dateRange,
  search,
}: ReportProps) {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await apiFetch(
        buildUrl(companyId, "quote-details", dateRange),
      );
      if (!res.ok)
        throw new Error(`Failed to load quote details (${res.status})`);
      return res.json();
    },
    enabled: !!companyId,
  });
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/2 border-r border-slate-100 overflow-auto">
        ...
        {filtered.length === 0 ? (
          <EmptyState message="No quotes in this period" />
        ) : (
          <table className="w-full text-xs">
            <thead className="sticky top-0 bg-white border-b border-slate-100">
              <tr>
        ...
        {!selectedRow ? (
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <DetailCard
                label="Expiry Date"
                value={fmtDate(selectedRow.expiryDate)}
              />
              <DetailCard label="Status" value={selectedRow.status} />
              <DetailCard label="Total" value={selectedRow.total} />
            </div>
...
export function CustomerBalanceSummaryReport({
  companyId,
  dateRange,
  search,
}: ReportProps) {
  ...
  const {
    ...
    queryKey: [
      "reports/customer-balance-summary",
      companyId,
      dateRange.from,
      dateRange.to,
    ],
    queryFn: async () => {
      const res = await apiFetch(
        buildUrl(companyId, "customer-balance-summary", dateRange),
      );
      if (!res.ok)
        throw new Error(
          `Failed to load customer balance summary (${res.status})`,
        );
      return res.json();
    },
    enabled: !!companyId,
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/2 border-r border-slate-100 overflow-auto">
        ...
        {filtered.length === 0 ? (
          <EmptyState message="No customer balances in this period" />
        ) : (
          <table className="w-full text-xs">
            <thead className="sticky top-0 bg-white border-b border-slate-100">
              <tr>
...
export function ReceivableSummaryReport({
  companyId,
  dateRange,
}: Omit<ReportProps, "search">) {
  const { data, isLoading, error } = useQuery<{
    ...
    queryFn: async () => {
      const res = await apiFetch(
        buildUrl(companyId, "receivable-summary", dateRange),
      );
      if (!res.ok)
        throw new Error(`Failed to load receivable summary (${res.status})`);
      return res.json();
    },
    enabled: !!companyId,
  });
    ...
    <div className="p-6">
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div
            key={label}
            className="bg-slate-50 rounded-2xl p-5 flex flex-col gap-2"
          >
...
export function ReceivableDetailsReport({
  companyId,
  dateRange,
  search,
}: ReportProps) {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await apiFetch(
        buildUrl(companyId, "receivable-details", dateRange),
      );
      if (!res.ok)
        throw new Error(`Failed to load receivable details (${res.status})`);
      return res.json();
    },
    enabled: !!companyId,
  });
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/2 border-r border-slate-100 overflow-auto">
        ...
        {filtered.length === 0 ? (
          <EmptyState message="No receivables in this period" />
        ) : (
          <table className="w-full text-xs">
            <thead className="sticky top-0 bg-white border-b border-slate-100">
              <tr>
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/2 border-r border-slate-100 overflow-auto">
        ...
        {filtered.length === 0 ? (
          <EmptyState message="No bad debts in this period" />
        ) : (
          <table className="w-full text-xs">
            <thead className="sticky top-0 bg-white border-b border-slate-100">
              <tr>
...
export function BankChargesReport({
  companyId,
  dateRange,
  search,
}: ReportProps) {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await apiFetch(
        buildUrl(companyId, "bank-charges", dateRange),
      );
      if (!res.ok)
        throw new Error(`Failed to load bank charges (${res.status})`);
      return res.json();
    },
    enabled: !!companyId,
  });
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/2 border-r border-slate-100 overflow-auto">
        ...
        {filtered.length === 0 ? (
          <EmptyState message="No bank charges in this period" />
        ) : (
          <table className="w-full text-xs">
            <thead className="sticky top-0 bg-white border-b border-slate-100">
              <tr>
