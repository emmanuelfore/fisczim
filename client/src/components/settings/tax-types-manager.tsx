  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "New tax rate added successfully.",
      });
    },
    onError: (err: any) =>
      toast({
  ...
  return (
    <div className="space-y-4">
      <div className="hidden">
        ...
        <button id="add-tax-trigger" onClick={openCreate}>
          Add
        </button>
      </div>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  setFormData({ ...formData, zimraTaxId: val })
                }
              >
