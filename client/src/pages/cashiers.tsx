          ...
          <Dialog open={isInviteOpen} onOpenChange={setIsInviteOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Send an invitation to a new user. They will be restricted to
                  the POS interface.
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter>
                <Button
                  onClick={() => inviteCashier.mutate()}
                  disabled={inviteCashier.isPending}
                >
                  {inviteCashier.isPending ? (
                ...
                <TableRow>
                  ...
                  >
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="">Add a new cashier to get started.</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : (
                    ...
                    <TableCell className="text-right">
                      <Button
                        ...
                        onClick={() => {
                          if (
                            confirm(
                              "Are you sure you want to remove this cashier? This will revoke their access to the company immediately.",
                            )
                          ) {
