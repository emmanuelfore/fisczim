...
export default function CashCollectionReportPage() {
  ...
  return (
    <Layout
      hideHeaderTitle
      headerTitle="Cash Collection Report"
      headerSubtitle="Review daily cash collected by cashier and payment method."
    >
          ...
          <div className="flex items-center gap-2">
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="h-10 rounded-[10px] border-[#E5E7EB] bg-white px-3  font-semibold text-[#0F172A] shadow-none justify-start lg:w-[235px]"
                >
