      ...
      <DialogTrigger asChild>
        {trigger ? (
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-8 w-8 p-0 rounded-full hover:bg-emerald-50 hover:text-emerald-600 transition-all"
          >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 p-5 bg-emerald-50/50 rounded-2xl border border-emerald-100">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs uppercase tracking-wide text-slate-500">
                      TIN
                    </FormLabel>
                    <FormControl>
                      <Input
                        ...
                        value={field.value || ""}
                        onChange={field.onChange}
                        className="rounded-lg bg-white border-emerald-200/50 focus-visible:ring-emerald-500/20 font-mono "
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
