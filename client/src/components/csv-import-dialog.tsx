          ...
          {type === "product" && (
            <Alert className="bg-primary/5 border-primary/20">
              ...
              <AlertDescription className="text-xs">
                Use <b>VAT</b>, <b>NON</b>, or <b>EXEMPT</b> in the Tax Type
                column. The "Tax Rate" column is now optional and ignored.
              </AlertDescription>
            </Alert>
          )}
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 flex items-center justify-between">
            ...
            <Button
              ...
              className="text-primary hover:text-primary hover:bg-white text-xs h-8"
            >
          ...
          <div className="space-y-3">
            <p className=" font-medium text-slate-700">2. Upload CSV</p>
