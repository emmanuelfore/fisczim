...
export default function ServicesPage() {
  ...
  const { bulkConvertMutation } = {
    bulkConvertMutation: useBulkConvertProducts(companyId),
  };
            ...
            <thead>
              <tr className="bg-slate-50 border-b border-slate-100">
                <th className="p-4 w-12">
                  <Checkbox
                    checked={
                      (paginatedServices?.length || 0) > 0 &&
                      selectedIds.length === paginatedServices?.length
                    }
              ...
              {isLoading ? (
                ...
                paginatedServices?.map((s) => {
                  ...
                  return (
                    <tr
                      key={s.id}
                      className={`data-table-row border-b border-slate-50 hover:bg-slate-50/50 transition-colors ${!s.isActive ? "opacity-50 grayscale" : ""} ${selectedIds.includes(s.id) ? "bg-primary/5" : ""}`}
                    >
                      ...
                      <td className="data-table-cell p-4 font-medium">
                      ...
                      <td className="data-table-cell p-4">
                        {matchedType ? (
                          ...
                          <span className="text-slate-500 ">{s.taxRate}%</span>
                        )}
                      </td>
        ...
        <AlertDialogContent className="rounded-[2rem] border-none shadow-2xl p-8">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-slate-500 text-lg">
              ...
              for these items and change their type to Products.
            </AlertDialogDescription>
          </AlertDialogHeader>
