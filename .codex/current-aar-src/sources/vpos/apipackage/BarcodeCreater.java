...
/* JADX INFO: loaded from: classes.jar:vpos/apipackage/BarcodeCreater.class */
public abstract class BarcodeCreater {
    ...
    public static Bitmap creatBarcode(String contents, int desiredWidth, int desiredHeight, BarcodeFormat barcodeFormat2) {
    ...
    protected static Bitmap encodeAsBitmap(String contents, BarcodeFormat format, int desiredWidth, int desiredHeight) {
        ...
        try {
            result = writer.encode(contents, format, desiredWidth, desiredHeight, (Map) null);
