...
ALTER TABLE "companies" ADD COLUMN IF NOT EXISTS "lekuka_gateway_url" text;
ALTER TABLE "tax_types" ADD COLUMN IF NOT EXISTS "lekuka_tax_id" text;
ALTER TABLE "tax_types" ADD COLUMN IF NOT EXISTS "lekuka_tax_type" text;
