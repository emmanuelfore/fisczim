...
export default function BusFleetPage() {
  ...
  return (
    <Layout>
      ...
      {!canManageFleet && !canManageFares && (
        <Card className="border-dashed border-slate-200 shadow-sm">
          <CardContent className="p-8 text-center  text-slate-500">
            Bus fleet and fare matrix tools are hidden by the current
            bus-ticketing settings.
          </CardContent>
        </Card>
      )}
      ...
      {(canManageFleet || canManageFares) && (
        <Tabs
          defaultValue={canManageFleet ? "vehicles" : "routes"}
          className="space-y-4"
        >
                          ...
                          >
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 font-bold  shadow-sm group-hover:scale-105 transition-transform duration-200">
                            ...
                            <td className="px-6 py-4">
                              <span
                                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide shadow-sm border ${
                                  v.isActive
                      ...
                      {loadingRoutes ? (
                        ...
                        filteredRoutes?.map((r: any) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <div className="inline-flex items-center px-2 py-1 rounded-lg bg-orange-50 text-orange-700 font-mono  font-bold border border-orange-100 shadow-sm">
