...
export default function CustomerDetailsPage() {
  ...
  const { data: invoicesResult, isLoading: isLoadingInvoices } = useInvoices(
    companyId,
    { limit: 100 },
  );
                  ...
                  {statementData && company && (
                    <>
                      <Button
                        ...
                        onClick={() =>
                          setLocation(
                            `/reports/customer-statements?customerId=${customerId}`,
                          )
                        }
                      >
                  ...
                  <div className="bg-slate-50 p-4 rounded-lg flex justify-between items-center border border-slate-100">
                    <div>
                      ...
                      <p className="text-xl font-bold text-slate-700">
                        {selectedCurrency}{" "}
                        {Number(statementData.openingBalance).toFixed(2)}
                      </p>
                    </div>
                    <div>
                      ...
                      >
                        {selectedCurrency}{" "}
                        {Number(statementData.closingBalance).toFixed(2)}
                      </p>
                    </div>
                  </div>
