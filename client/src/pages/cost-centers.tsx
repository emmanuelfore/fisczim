...
export default function CostCentersPage() {
  ...
  const totals = costCenters?.reduce(
    (acc, curr) => ({
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className=" text-slate-500">
                Track profitability across different branches and departments
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className=" font-semibold text-slate-600">From:</div>
            <Input
              type="date"
              value={fromDate}
            ...
            />
            <div className=" font-semibold text-slate-600">To:</div>
            <Input
              type="date"
              value={toDate}
        ...
        <Card className="rounded-2xl border-slate-200">
          <CardHeader>
            <CardTitle className="text-lg">
              Profitability by Cost Center (Branch)
            </CardTitle>
            <CardDescription>
            ...
            <Table>
              <TableHeader className="bg-slate-50/50">
                <TableRow>
                  ...
                  <TableHead className="text-right pr-6 font-bold text-primary">
                    Net Profit
                  </TableHead>
                </TableRow>
              </TableHeader>
