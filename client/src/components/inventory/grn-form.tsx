      ...
      },
      {
        onSuccess: () => {
          toast({
            title: "GRN Recorded",
            description:
              "Batch stock has been successfully added to inventory.",
          });
          setOpen(false);
          form.reset();
        },
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          {...field}
                          placeholder="GRN Number, Batch, etc."
                          className="h-10 border-slate-200 rounded-lg focus:ring-primary/20"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
              ...
              <div className="rounded-xl border border-slate-100 overflow-hidden shadow-sm">
                ...
                <div className="divide-y divide-slate-50">
                  {fields.map((field, index) => (
                    <div
                      key={field.id}
                      className="p-3 grid grid-cols-[1fr,100px,120px,40px] gap-4 items-start group"
                    >
                      <FormField
                        control={form.control}
                          ...
                          <FormItem className="space-y-1">
                            <FormControl>
                              <Input
                                {...field}
                                placeholder="0.00"
                                className="h-9 text-xs border-slate-200 rounded-md focus:ring-primary/20"
                              />
                            </FormControl>
                            <FormMessage className="text-[10px]" />
                          </FormItem>
                            ...
                            <FormControl>
                              <div className="relative">
                                ...
                                <Input
                                  {...field}
                                  placeholder="0.00"
                                  className="h-9 text-xs pl-8 border-slate-200 rounded-md focus:ring-primary/20 text-right font-mono"
                                />
                              </div>
                            </FormControl>
                            <FormMessage className="text-[10px]" />
                ...
                <div className="p-3 bg-slate-50/20 border-t border-slate-50">
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      append({ productId: "", quantity: "", unitCost: "" })
                    }
