                ...
                <div className="space-y-4 py-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-500">
                      Provide the invoice number given by the supplier.
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-slate-500">
                        Clear this field to use each product's configured VAT
                        rate.
                      </p>
                    </div>
                    <div className="flex items-center justify-between rounded-lg border border-slate-200 px-3 py-2 mt-6">
                      <Label htmlFor="grv-vat-inclusive" className="">
                        Amounts include VAT
                      </Label>
                      <Switch
                        id="grv-vat-inclusive"
                    ...
                    <table className="w-full text-left text-xs">
                      <thead className="bg-slate-50">
                        <tr>
                          ...
                          <th className="p-2 text-right font-bold text-slate-500">
                            Qty
                          </th>
                          <th className="p-2 text-right font-bold text-slate-500">
                            VAT %
                      ...
                      <tbody>
                        {invoiceLinePreview.map((line) => (
                          ...
                          >
                            ...
                            <td className="p-2 text-right font-mono">
                              {currency} {line.taxAmount.toFixed(2)}
                            </td>
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50/60 p-3 space-y-2">
                    <div className="flex justify-between ">
                      ...
                      <span className="font-mono font-semibold">
                        {currency} {invoiceSubtotal.toFixed(2)}
                      </span>
                    </div>
                    <div className="flex justify-between ">
                      <span className="text-slate-500">Input VAT</span>
                      <span className="font-mono font-semibold">
                        {currency} {invoiceTaxAmount.toFixed(2)}
                      </span>
                    </div>
                  ...
                  <div className="flex justify-end gap-2 pt-4">
                    ...
                    <Button
                      ...
                      disabled={
                        createInvoiceMutation.isPending || !invoiceNumber
                      }
                    >
          ...
          <CardContent className="p-8">
                ...
                <tbody>
                  {grv.lines.map((line) => (
                    ...
                    >
                      ...
                      <td className="p-4  font-medium text-slate-700 text-right">
                        {line.quantity.toFixed(2)}
                      </td>
                      <td className="p-4  font-medium text-slate-700 text-right">
            ...
            {grv.notes ? (
              <div className="mt-6 rounded-xl border border-slate-200 p-4">
                ...
                <p className=" text-slate-700">{grv.notes}</p>
              </div>
            ) : null}
          </CardContent>
        </Card>
