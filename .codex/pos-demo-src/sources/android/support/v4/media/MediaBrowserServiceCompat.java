        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS), (ResultReceiver) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), MediaBrowserServiceCompat.this.new ServiceCallbacksCompat(msg.replyTo));
                    break;
                default:
