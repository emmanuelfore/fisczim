          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-800 font-display">
                Account Ledger: {account?.name || "Loading..."}
              </h2>
              <p className=" text-slate-500">
                Chronological history for account {account?.code}
              </p>
            </div>
          </div>
        </div>
            ...
            <Table>
              <TableHeader className="bg-slate-50/50">
                <TableRow className="border-slate-50">
                  <TableHead className="pl-6 font-bold text-slate-500 text-[10px] uppercase tracking-widest">
                    Date
                  </TableHead>
                  <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest text-center">
                    Reference
                  </TableHead>
                  <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest">
                    Narrative
                  </TableHead>
                  <TableHead className="text-right font-bold text-slate-500 text-[10px] uppercase tracking-widest">
                    Debit
                  </TableHead>
                  <TableHead className="text-right font-bold text-slate-500 text-[10px] uppercase tracking-widest">
                    Credit
                  </TableHead>
                  <TableHead className="text-right pr-6 font-bold text-slate-900 text-[10px] uppercase tracking-widest">
                    Running Balance
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {isLoading ? (
                  ...
                  entriesWithBalance?.map((entry) => (
                    <TableRow
                      key={entry.id}
                      className="hover:bg-slate-50/40 border-slate-50 transition-colors"
                    >
