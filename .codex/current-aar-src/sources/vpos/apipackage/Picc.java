...
/* JADX INFO: loaded from: classes.jar:vpos/apipackage/Picc.class */
public class Picc {
    ...
    public static native int Lib_PiccPoll(byte b, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6);
    ...
    public static native int Lib_PiccM1Authority(byte b, int i, byte[] bArr, byte[] bArr2);

    public static native int Lib_PiccM1ReadBlock(int i, byte[] bArr);

    public static native int Lib_PiccM1WriteBlock(int i, byte[] bArr);

    public static native int Lib_PiccM1Operate(byte b, int i, byte[] bArr, byte b2);
    ...
    public static native int Lib_PiccSamMfcAuth(byte b, int i, byte b2, byte b3);
    ...
    public static native int Lib_MifareKeyStore(byte b, byte[] bArr);

    public static native int Lib_MifareKeyAuth(byte b, byte b2, byte b3);
