        ...
        <CardContent className="space-y-6 pt-4">
          ...
          <div className="bg-amber-50/50 p-4 rounded-2xl border border-amber-100 flex gap-3">
            ...
            <div className="space-y-1">
              <p className="text-xs text-amber-900 font-bold uppercase tracking-tighter">
              ...
              <p className="text-xs text-amber-800 leading-relaxed font-medium italic">
                ...
                before emails can be sent to external addresses. For testing,
                you can use <code>onboarding@resend.dev</code>.
              </p>
            </div>
          </div>
        </CardContent>
