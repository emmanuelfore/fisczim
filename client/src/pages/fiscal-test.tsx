...
import { getLekakuGatewayUrl } from "@shared/lekaku";
...
export default function FiscalTestPage() {
  ...
  // Lesotho hits the RSL LEKAKU gateway; Zimbabwe hits ZIMRA FDMS.
  const p = isLesotho ? "/lekaku" : "/zimra";
  const gateway = isLesotho
    ? ((currentCompany as any)?.lekakuGatewayUrl || getLekakuGatewayUrl((currentCompany as any)?.zimraEnvironment)).trim()
    : null;
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card>
            <CardHeader className="pb-3">
              ...
              {isLesotho && gateway && (
                <p className="px-6 pb-1 font-mono text-[11px] text-emerald-700 break-all">
                  RSL gateway: {gateway}
                </p>
              )}
            </CardHeader>
            <CardContent className="space-y-3">
              <Button
                ...
                onClick={() => runAction("Get Status", `${p}/status`, "GET")}
              ...
              <Button
                variant="outline"
                className="w-full justify-start"
                onClick={() => runAction(isLesotho ? "Ping RSL Gateway" : "Ping Server", `${p}/ping`, "POST")}
                disabled={!!loadingAction}
              >
                <Activity className="w-4 h-4 mr-2" />
                Ping Server
              ...
              <Button
                ...
                onClick={() =>
                  (isLesotho
                    ? runAction("Tax Health Check", `${p}/tax-health`, "GET")
                    : runAction("Connectivity Test", `${p}/connectivity-test`, "POST"))
                }
                disabled={!!loadingAction}
              >
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button
                ...
                onClick={() =>
                  runAction("Open Fiscal Day", `${p}/day/open`, "POST")
                }
                disabled={!!loadingAction}
              >
              ...
              {!isLesotho && (
                <Button
                  ...
                  onClick={() =>
                    runAction("Close Fiscal Day", `${p}/day/close`, "POST")
                  }
                  disabled={!!loadingAction}
                >
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button
                ...
                className="w-full justify-start"
                onClick={() =>
                  runAction("Sync Config", `${p}/config/sync`, "POST")
                }
                disabled={!!loadingAction}
              >
              ...
              <Button
                ...
                className="w-full justify-start"
                onClick={() =>
                  runAction("Get Applicable Taxes", `${p}/applicable-taxes`, "GET")
                }
                disabled={!!loadingAction}
              >
                ...
                onClick={() =>
                  runAction(
                    ...
                    "POST",
                    {
                      ...
                      deviceSerialNo: (currentCompany as any).fdmsDeviceSerialNo || undefined,
                    },
                  )
                }
                disabled={!!loadingAction}
          ...
          <Card className="h-full flex flex-col">
            <CardHeader className="pb-2 border-b">
              <div className="flex justify-between items-center">
                <CardTitle className="font-mono  uppercase text-slate-500">
                  Response Console
                </CardTitle>
                <Button
                  variant="ghost"
