                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-slate-700 font-semibold">Registration Number (Plate)</FormLabel>
                                    <FormControl>
                                        <Input placeholder="e.g. ABC 1234" {...field} className="rounded-xl bg-slate-50 border-slate-200" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-slate-700 font-semibold">Fleet Number</FormLabel>
                                    <FormControl>
                                        <Input placeholder="e.g. BUS-001" {...field} value={field.value || ""} className="rounded-xl bg-slate-50 border-slate-200" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-slate-700 font-semibold">Capacity</FormLabel>
                                        <FormControl>
                                            <Input type="number" {...field} onChange={e => field.onChange(parseInt(e.target.value))} className="rounded-xl bg-slate-50 border-slate-200" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-slate-700 font-semibold">Model/Make</FormLabel>
                                        <FormControl>
                                            <Input placeholder="e.g. Yutong ZK6122H" {...field} value={field.value || ""} className="rounded-xl bg-slate-50 border-slate-200" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                            ...
                            <Button type="submit" disabled={createVehicle.isPending} className="rounded-xl bg-orange-600 hover:bg-orange-700 text-white">
