                  ...
                  <td colSpan={5} className="p-12 text-center text-slate-500">
                    <div className="flex flex-col items-center justify-center py-12">
                      ...
                      <p className=" text-slate-500">
                        Inventory history will appear here once you record sales
                        or stock-ins.
                      </p>
                    </div>
                  </td>
                ...
                paginatedTransactions?.map((t) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-6 align-middle">
                        <span
                          className={` font-black ${isPositive ? "text-emerald-600" : "text-blue-600"}`}
                        >
                          {isPositive ? "+" : ""}
                      ...
                      <td className="p-6 align-middle">
                        <div className="flex flex-col gap-1">
                          <Badge
                            variant="outline"
                            className="w-fit text-[10px] font-bold uppercase tracking-widest bg-white"
                          >
