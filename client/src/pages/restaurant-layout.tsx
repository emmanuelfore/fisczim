      ...
      <Layout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
          ...
          <p className="text-muted-foreground text-center max-w-md">
            We couldn't find an active company for your account. Please ensure
            you are assigned to a company or create one to continue.
          </p>
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card
            className="hover:bg-accent/10 transition-colors cursor-pointer border-zinc-200/50 shadow-lg bg-white/5 backdrop-blur-sm"
            onClick={() => setLocation("/restaurant/kds")}
          >
          ...
          <Card
            className="hover:bg-accent/10 transition-colors cursor-pointer border-zinc-200/50 shadow-lg bg-white/5 backdrop-blur-sm"
            onClick={() =>
              window.open(`/order-status?companyId=${company.id}`, "_blank")
            }
          >
            <CardHeader className="flex flex-row items-center gap-4">
              <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center">
              ...
              <div>
                ...
                <CardDescription>
                  Open the public status screen for customers.
                </CardDescription>
              </div>
            </CardHeader>
          </Card>
