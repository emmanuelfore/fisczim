    ...
    <div className="min-h-screen flex flex-col bg-slate-900 text-white">
      {updateInfo && (
        <div className="bg-blue-500 text-white p-3 flex items-center justify-between z-50">
          ...
          <button
            className="px-3 py-1 bg-white text-blue-600 rounded font-semibold  hover:bg-blue-50 transition-colors"
      ...
      <div className="flex-1 flex items-center justify-center relative overflow-hidden p-6">
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="text-center mb-8">
            ...
            {!isOnline && (
              <div className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-orange-500/20 text-orange-400 border border-orange-500/30  font-semibold">
          ...
          <Card className="bg-white/5 backdrop-blur-2xl border-white/10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] rounded-[2.5rem] overflow-hidden">
            ...
            <CardContent className="p-8 pt-6">
              {error && (
                <div className="mb-6 p-4 rounded-2xl bg-red-500/10 text-red-400  border border-red-500/20 flex items-center gap-3">
              ...
              {isBrokenStorage && (
                <div className="mb-6 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20">
                  <p className="text-amber-400 text-xs font-medium mb-3">
                    Database access failed. This is often caused by an
