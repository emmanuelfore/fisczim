        ...
        if (keyCode != 62) {
            switch (keyCode) {
                ...
                case MotionEventCompat.AXIS_RUDDER /* 20 */:
                    if (!event.isAltPressed()) {
                        boolean handled3 = arrowScroll(TransportMediator.KEYCODE_MEDIA_RECORD);
                    } else {
                        boolean handled4 = fullScroll(TransportMediator.KEYCODE_MEDIA_RECORD);
                    }
                    break;
            }
            return false;
            ...
            case 2:
                ...
                if (activePointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (overScrollByCompat(0, deltaY2, 0, getScrollY(), 0, range, 0, 0, true) && !hasNestedScrollingParent()) {
                            this.mVelocityTracker.clear();
                        }
